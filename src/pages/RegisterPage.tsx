...
const RegisterPage = () => {
    ...
    const handleRegister = async () => {
        ...
        await axios.post(url, querystring.stringify(params)).then((resp) => {
    ...
    return (
        <div css={styles.loginFormWrapper}>
            ...
            <div css={{
                ...
                <div css={{textAlign: "left"}}><label>First Name</label></div>
                <div><input onInput={setFitstName} type="text" /></div>
            </div>
            <div css={{
                marginBottom: '10px'
            }}>
                <div css={{textAlign: "left"}}><label>Last Name</label></div>
                <div><input onInput={setLastNmae} type="text" /></div>
            </div>
            <div css={{
                marginBottom: '10px'
            }}>
